  ...
  describe "::read_congruence" do
    context "when input contains no '\='" do
      it "raises an ArgumentError" do
        ...
        expect {PolynomialInterpreter.read_congruence not_congruence}
          .to raise_error PolynomialInterpreter::CongruenceInvalid
      end
    end
    ...
    context "when lhs is empty" do
      it "raises an ArgumentError" do
        congruence = "= 3 (mod 4)"
        expect {PolynomialInterpreter.read_congruence congruence}
          .to raise_error PolynomialInterpreter::LhsPolynomialInvalid
      end
    end
    ...
    context "when rhs is empty" do
      it "raises an ArgumentError" do
        ...
        expect {PolynomialInterpreter.read_congruence congruence}
          .to raise_error PolynomialInterpreter::RhsPolynomialInvalid
      end
    end
    ...
    context "when input is a valid polynomial congruence" do
      it "formats congruence as a single polynomial congruent to 0" do
        ...
        expect( PolynomialInterpreter.read_congruence(congruence))
          .to eq [[-1, 0, 0, 3, 48, 0, 0, 5, -8, 5].reverse, 16]
      end
    end
  end
end
