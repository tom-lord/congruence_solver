  ...
  describe "::read_congruence" do
    context "when input contains no '\='" do
      it "raises an ArgumentError" do
        ...
        expect {PolynomialInterpreter.read_congruence not_congruence}.to raise_error PolynomialInterpreter::CongruenceInvalid
      end
    end
    ...
    context "when lhs is empty" do
      it "raises an ArgumentError" do
        congruence = "= 3 (mod 4)"
        expect {PolynomialInterpreter.read_congruence congruence}.to raise_error PolynomialInterpreter::LhsPolynomialInvalid
      end
    end
    ...
    context "when rhs is empty" do
      it "raises an ArgumentError" do
        ...
        expect {PolynomialInterpreter.read_congruence congruence}.to raise_error PolynomialInterpreter::RhsPolynomialInvalid
      end
    end
